...
CLVM 是 Chia 网络使用的 ChiaLisp 的编译的最小版本。. Chialisp compiles into CLVM so it's important to understand how it works. The full set of operators is documented [here](/docs/ref/clvm).
