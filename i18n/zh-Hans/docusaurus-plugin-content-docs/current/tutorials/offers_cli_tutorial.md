...
The asset IDs for Chia's main CATs are stored in `chia-blockchain/chia/wallet/cc_wallet/cat_constants.py`

The ID for Stably USD (USDS), which we'll use for this example, is `6d95dae356e32a71db5ddcb42224754a02524c615c5fc35f568c2af04774e589`
